        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <CardHeader className="text-center pb-4">
              <div className="mx-auto mb-4 bg-gradient-to-br from-teal-500 to-emerald-600 p-6 rounded-2xl w-fit">
                <LogIn className="h-10 w-10 text-white" />
              </div>
              <CardTitle className="text-2xl text-slate-800">Fazer Login</CardTitle>
          ...
          >
            <CardHeader className="text-center pb-4">
              <div className="mx-auto mb-4 bg-gradient-to-br from-cyan-500 to-teal-600 p-6 rounded-2xl w-fit">
                <MessageCircleQuestion className="h-10 w-10 text-white" />
              </div>
              <CardTitle className="text-2xl text-slate-800">Tire sua Dúvida</CardTitle>
              <CardDescription className="text-base">
